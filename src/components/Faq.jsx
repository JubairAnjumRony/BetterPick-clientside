...
// import LottieFAQ from '../assets/lottie.json'
...
const Faq = () => {
    ...
    const faqs = [
        {
            question: "What is BetterPick?",
            answer:
                "BetterPick is a platform that allows users to ask questions, receive recommendations, and share feedback on various topics.",
        },
        {
        ...
        <div className="container mx-auto my-10 px-2 xl:px-0">
            ...
            <div className="text-center mb-12 px-5">
                <h2 className="text-4xl font-extrabold text-gray-800 mb-4">
                    <span className="text-blue-300">Frequently</span> <span className="text-blue-300">Asked Questions</span>
                </h2>
                {/* <p className="text-lg ">
