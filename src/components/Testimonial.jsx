...
const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      id: 2,
      name: "Michael Smith",
      image: "https://i.ibb.co/LzNpNY8/pexels-justin-shaifer-501272-1222271.jpg",
      rating: 4,
    ...
    },
    {
      ...
      rating: 5,
      comment: "The recommendations are spot on. I found what I needed quickly.",
    },
    {
      id: 5,
      name: "Emma Brown",
      ...
      rating: 4,
      comment: "Highly satisfied with the service. The interface is user-friendly.",
    },
  ];
